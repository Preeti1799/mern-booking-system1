...
const Hotel = () => {
  ...
  const dayDifference = (date1, date2) => {
    ...
    const diffDays = timeDiff / MILLISECONDS_PER_DAY;
      ...
      <div className="hotelContainer">
        ...
        <div className="hotelWrapper">
          ...
          <span className="hotelPriceHighlight">
            Book a stay over ${pricePerNight} at this property and get a free airport taxi
          </span>
          ...
          <div className="hotelDetails">
            <div className="hotelDetailsTexts">
              ...
              <p className="hotelDesc">
                Located a 5-minute walk from India Gate in Mumbai, Tower Street
            ...
            <div className="hotelDetailsPrice">
              ...
              <h2>
                <b>${pricePerNight * nights}</b> ({nights} nights)
              </h2>
